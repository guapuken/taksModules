  ...
  style={{    
    ...
    {!Content && 
      <div style={{display:'flex',height:`${height}rem`}}>
        <div style={{ width:`${width - 2}rem`, height:`${height - 2}rem`, margin:'auto', marginTop:`${(height / 2)-2.5}rem`}}>
          <p style={{fontSize:'2rem', marginBlock:'0'}}>Without content 😥</p>
          <p style={{fontSize:'1.4rem', marginBlock:'0'}}>Add property Content and see it </p>
        </div>
      </div>
    }
    {Content && 
    <div style={{display:'flex',height:`${height}rem`, position:'relative'}}>
      <div style={{ width:`${width - 2}rem`, height:`${height - 2}rem`, margin:'auto'}}>
        <Content {...data}/>
      </div>
      { Aside &&
      <div style={{
