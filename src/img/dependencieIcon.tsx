...
export const DependenceIcon = ({ modo }: any) => {
	return (
		<svg
			version="1.1"
			id="Capa_1"
		...
		>
			<g>
				<path
					fill={modo === 'Dark' ? '#242424' : '#dedede'}
					d="M27.73,8.91c0,1.8-0.7,3.49-1.98,4.77l-3.57,3.57l-1.64,1.65c-0.4,0.39-0.83,0.72-1.29,1
		...
		c-0.29,0-0.57,0.02-0.84,0.05l3.57-3.58c1.27-1.27,2.97-1.97,4.77-1.97c1.8,0,3.5,0.7,4.77,1.97C27.03,5.41,27.73,7.1,27.73,8.91z"
				...
				<path
					fill={modo === 'Dark' ? '#242424' : '#dedede'}
					d="M6.27,18.31c-0.71,0.71-1.1,1.65-1.1,2.65s0.39,1.95,1.1,2.65c1.46,1.47,3.84,1.47,5.31,0l1.25-1.25
